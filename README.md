...
* [Official Repository](https://github.com/less/less.js) ⭐ 17,026 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-21

**[Back to top](#contents)**

## UI/Theme Frameworks and Components

* [Ant Design](https://github.com/ant-design/ant-design/) ⭐ 99,573 | 🐛 1,074 | 🌐 TypeScript | 📅 2026-09-21 - 	An enterprise-class UI design language and React-based implementation.
...
* [Material Design for Bootstrap](https://github.com/FezVrasta/bootstrap-material-design) ⭐ 25 | 🐛 0 | 🌐 HTML | 📅 2021-05-21 - Material Design for Bootstrap is a Bootstrap V3 compatible theme; it is an easy way to use the new Material Design guidelines by Google in your Bootstrap 3 based application.
...
* [Framework](https://github.com/jonikorpi/Less-Framework) ⚠️ Archived - Less Framework is a CSS grid system for designing adaptive web sites. It contains 4 layouts and 3 sets of typography presets, all based on a single grid.
* [Bootstrap Grid Only](https://github.com/zirafa/bootstrap-grid-only) ⭐ 445 | 🐛 3 | 🌐 CSS | 📅 2017-08-16 - Bootstrap's responsive grid and responsive utility classes only, without any extras. Lightweight yet still powerful. Style to taste.
* [Order.Less](https://github.com/chromice/order.less) ⭐ 21 | 🐛 0 | 🌐 CSS | 📅 2017-08-09 - Baseline alignment, column grids and modular scales.
* [Grid System](https://github.com/goodpixels/less-grid-system) ⭐ 8 | 🐛 1 | 🌐 CSS | 📅 2015-10-07 - Super-easy to use, markup-independent grid system.
* [Less Zen Grid](https://github.com/bassjobsen/LESS-Zen-Grid) ⭐ 5 | 🐛 0 | 🌐 CSS | 📅 2014-09-08 - Implementation of [Zen Grids](https://github.com/JohnAlbin/zen-grids) ⭐ 229 | 🐛 23 | 🌐 CSS | 📅 2022-01-26 in Less.
...
* [CSS and Media Query Strategies](https://github.com/buymeasoda/less-media-queries) ⭐ 17 | 🐛 0 | 📅 2012-11-16 - Using Less CSS to develop a media query driven solution for modern and legacy browsers.
* [Media Queries Library](https://github.com/mrmlnc/less-mq) ⚠️ Archived - Really simple media queries in Less.
* [Media Query to Type](https://github.com/himedlooff/media-query-to-type) ⭐ 10 | 🐛 1 | 🌐 CSS | 📅 2014-01-09 - A method for creating an IE specific stylesheet that allows the content of media queries to become accessible to Internet Explorer 8 and below.

**[Back to top](#contents)**

### Color

* [Open Color](https://github.com/yeun/open-color) ⭐ 5,566 | 🐛 26 | 🌐 Handlebars | 📅 2023-12-10 - Open color is a color scheme for UI design. Available in CSS, SCSS, Less, Stylus, Adobe library, Photoshop/Illustrator swatches and Sketch palette.
...
* [Animate Less](https://github.com/machito/animate.less) ⭐ 530 | 🐛 0 | 🌐 CSS | 📅 2019-08-05 - Port of Dan Eden's [Animate.css](https://daneden.github.io/animate.css/) to Less.
* [Cube Less](https://github.com/sparanoid/cube.less) ⭐ 55 | 🐛 1 | 🌐 Less | 📅 2026-07-07 - 3D (animated) cube using only CSS (Less), originally used by LeanCloud (aka. AVOS Cloud).
* [Animate](https://github.com/joshuapekera/animate) ⭐ 45 | 🐛 1 | 🌐 HTML | 📅 2017-09-06 - A library of CSS3 keyframe animations authored using Less.
* [Less Burguer](https://github.com/MarkRabey/less-burger) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2015-12-01 - Port of [Sass Burger](http://joren.co/sass-burger/) to Less.
...
* [Lesshat](https://github.com/madebysource/lesshat) ⭐ 2,168 | 🐛 59 | 🌐 JavaScript | 📅 2022-03-23 - Smart mixins library.
* [Preboot](https://github.com/mdo/preboot) ⭐ 1,661 | 🐛 5 | 🌐 CSS | 📅 2016-01-20 - Collection of mixins and variables for writing better CSS.
...
* [Handshake Style Guide](https://github.com/handshake/less-style-guide) ⭐ 9 | 🐛 0 | 📅 2016-10-10 - This guide presents a collection of best-practices and coding conventions.
* [WebMD Health Services Style Guide](https://github.com/bitmap/less-styleguide) ⭐ 2 | 🐛 0 | 📅 2014-06-06 - This document outlines CSS/Less best practices at WebMD Health Services.
...
* [ILess](https://github.com/mishal/iless) ⭐ 47 | 🐛 5 | 🌐 PHP | 📅 2019-04-29 - PHP port written in Javascript.
...
* [Pyhton Compiler](https://github.com/lesscpy/lesscpy) ⭐ 144 | 🐛 37 | 🌐 Less | 📅 2026-07-30 - Compiler written in Python.

**[Back to top](#contents)**

### Ruby

* [Ruby Compiler](https://github.com/cowboyd/less.rb) ⚠️ Archived - Less in Ruby's V8 Engine.

**[Back to top](#contents)**

### Go

* [Go Compiler](https://github.com/kib357/less-go) ⭐ 17 | 🐛 1 | 🌐 JavaScript | 📅 2017-08-21 - Runs Less inside embedded Javascript engine.

**[Back to top](#contents)**

## GUIs, Editors and Plugins

* [Hayaky](https://github.com/hayaku/hayaku) ⭐ 964 | 🐛 110 | 🌐 Python | 📅 2019-06-24 - Hayaku is a bundle of useful scripts aiming for rapid front-end web development.
* [Grunt Contrib](https://github.com/gruntjs/grunt-contrib-less) ⭐ 663 | 🐛 28 | 🌐 JavaScript | 📅 2026-06-23 - Compile Less files to CSS using Grunt.
* [Vim Less](https://github.com/groenewege/vim-less) ⭐ 598 | 🐛 6 | 🌐 VimL | 📅 2016-04-25 - This vim bundle adds syntax highlighting, indenting and autocompletion.
...
* [Eclipse Transpiler Plugin](https://github.com/gossi/eclipse-transpiler-plugin) ⭐ 20 | 🐛 10 | 🌐 Java | 📅 2017-06-23 - Eclipse plugin to automatically transpile your files (Less, SASS, CoffeeScript, etc.).
* [Atom Linter](https://github.com/josa42/atom-linter-less) ⚠️ Archived - Linter plugin in the Atom text editor.
...
* [Contributing to Less](https://github.com/less/less.js/blob/master/CONTRIBUTING.md) ⭐ 17,026 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-21
...
Your contributions are always welcome! [Click Here to read the guidelines](https://github.com/LucasBassetti/awesome-less/blob/master/CONTRIBUTING.md) ⭐ 68 | 🐛 1 | 📅 2022-08-16.
